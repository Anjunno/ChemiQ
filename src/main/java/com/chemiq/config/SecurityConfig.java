...
import com.chemiq.jwt.CustomLogoutFilter;
import com.chemiq.jwt.JWTFilter;
import com.chemiq.jwt.JWTUtil;
import com.chemiq.jwt.LoginFilter;
import com.chemiq.repository.RefreshTokenRepository;
import com.chemiq.service.RefreshTokenService;
...
//                })));
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/internal/**").permitAll() // 내부 API 경로 인증 없이 허용
